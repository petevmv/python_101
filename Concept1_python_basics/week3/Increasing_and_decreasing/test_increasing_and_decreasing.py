...
class TestIcreasingAndDecreasing(unittest.TestCase):
	def test_increasing_or_decresing(self):
		tests = [([1, 2, 3, 4, 5], Monotonicity.INCREASING),
		...
		with self.subTest('Testing proper behaivior of increasing_or_decresing'):
